...
public class ExtendableArmPIDController extends PIDControllerBase {
  ...
  private ExtendableArmPIDController() {
    ...
    topArmEncoder.putSensorOnLiveWindow(super.subsystemName, "ExtensionTopEncoder");
    bottomArmEncoder.putSensorOnLiveWindow(super.subsystemName, "ExtensionBottomEncoder");
