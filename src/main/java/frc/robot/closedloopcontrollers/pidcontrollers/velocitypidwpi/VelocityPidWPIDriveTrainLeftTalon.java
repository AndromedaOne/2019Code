...
public class VelocityPidWPIDriveTrainLeftTalon extends VelocityPidWPIForTalon {
    double m_p = 0.0;
    double m_i = 0.0;
    double m_d = 0.0;
    double m_f = 0.0;

    public VelocityPidWPIDriveTrainLeftTalon() {
        super(DriveControlFactory.getLeftMaster(), 0, 0, 0, 0, "DriveTrain", "WPIVelocityPidLeft");
