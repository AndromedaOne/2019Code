// This file was copied and renamed from DifferentialDrive.class from the WPI
// library.
// It is about to be modified to support TalonSRX speed controllers operating in
 ...
 * the same response.
 */
public class TalonSRXDifferentialDrive extends RobotDriveBase {
   ...
   */
  public TalonSRXDifferentialDrive(SpeedController leftMotor, SpeedController rightMotor) {
   ...
   * Forward is positive.
   * @param rightSpeed The robot right side's speed along the X axis [-1.0..1.0].
   * Forward is positive.
   * @param squareInputs If set, decreases the input sensitivity at low speeds.
   */
   ...
   * output changes. Values between 1.0 and 2.0 result in output oscillation.
   * Values below 0.0 and above 2.0 are unstable.
   */
