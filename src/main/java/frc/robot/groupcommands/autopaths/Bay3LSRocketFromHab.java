...
public class Bay3LSRocketFromHab extends CommandGroup {
    /**
     * This group command takes the Robot from the Hab zone to Bay  3, and from Bay 3,
     * it moves back to the Loading Station to pick up an unspecified game piece and moves to
     * the side closest to the driver station on the rocket. There it's up to the driver to 
     * decide which level the robot should raise its arm to, but for default purposes, it will
     * always raise to the lowest hatch port.
     */
