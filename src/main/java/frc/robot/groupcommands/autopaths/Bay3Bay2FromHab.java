...
public class Bay3Bay2FromHab extends CommandGroup {
  /**
   * Left and Right Level 1 Hatch Pannel Autonomous placement for Bays 2 and 3 of
   * the respective side of the platform. Calling isLevel1RightSide as true tells
   * the robot that it is currently on the right side of the level 1 platform,
