...
public class RealUltrasonicSensorPair extends UltrasonicSensor {
    ...
    /**
     * Creates an ultrasonic pair which takes in two ultrasonics and assumes
    ...
    public RealUltrasonicSensorPair(int leftPing, int leftEcho, int rightPing, int rightEcho) {
        // Everytime we add new ultrasonics we need to disable automatic mode and re enable it
    ...
    /**
     * This will default to return the average between the two ultrasonics, but if the 
     * difference between the two ultrasonics are above our threshold then it will return 
     * the ultrasonic with the lowest value.
     */
    @Override
